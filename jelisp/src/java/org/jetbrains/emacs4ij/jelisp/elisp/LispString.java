 ...
 */
public final class LispString implements LispAtom, LispSequence, LispArray, StringOrVector, HasTextPropertiesHolder {
  private String myData;
  private TextPropertiesHolder myTextPropertiesHolder = new TextPropertiesHolder() {
    @Override
    protected int size() {
      return LispString.this.size();
    }
  };
  ...
  public String toString() {
    if (myTextPropertiesHolder.noTextProperties())
      return '"' + myData + '"';
    return "#(\"" + myData + "\" " + myTextPropertiesHolder.intervalsString() + ")";
  }
  ...
  public boolean equals(Object o) {
    ...
    if (myTextPropertiesHolder != null ? !myTextPropertiesHolder.equals(that.myTextPropertiesHolder) : that.myTextPropertiesHolder != null) return false;
  ...
  public LispString substring(int from, int to, boolean withProperties) {
    ...
    return !myTextPropertiesHolder.noTextProperties() && withProperties
        ? new LispString(myData.substring(from, to), myTextPropertiesHolder.getTextPropertiesInRange(from, to))
        : new LispString(data);
  }

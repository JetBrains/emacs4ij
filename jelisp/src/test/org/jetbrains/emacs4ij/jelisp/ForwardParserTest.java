...
//        System.out.println(((LispInteger) c).getData());
    ...
    public void testAllModifiers() {
        LObject c = p.parseLine("?\\M-\\C-\\H-\\S-\\s-\\A-a");

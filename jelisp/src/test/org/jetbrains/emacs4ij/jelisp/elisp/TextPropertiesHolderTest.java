...
public class TextPropertiesHolderTest {
    ...
    public void testAddProperties() {
        ...
        Assert.assertTrue(holder.addTextProperties(0, 11, LispList.list(new LispSymbol("one"), new LispInteger(1))));
        ...
        Assert.assertTrue(holder.addTextProperties(4, 6, LispList.list(new LispSymbol("two"), new LispInteger(2))));
        ...
        Assert.assertTrue(holder.addTextProperties(4, 6,

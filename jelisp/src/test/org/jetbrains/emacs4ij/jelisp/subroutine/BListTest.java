...
public class BListTest extends JelispTestCase {
  @Test
  ...
  public void testCarWrongArg() {
    try {
      ...
      Assert.assertTrue(getCauseMsg(e).contains("wrong-type-argument"));
      return;
    }
    Assert.fail();
  }
  ...
  public void testMemqCons() {
    try {
      ...
      Assert.assertEquals("'(wrong-type-argument listp 3)", getCauseMsg(e));
    }
  }
  ...
  public void testNReverseCons () {
    try {
      ...
      Assert.assertEquals("'(wrong-type-argument listp (1))", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testDelqWrong() {
    try {
      ...
      Assert.assertEquals("'(wrong-type-argument listp (2 . 1))", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testLengthAppended() {
    ...
    try {
      ...
      Assert.assertEquals("'(wrong-type-argument listp 4)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }

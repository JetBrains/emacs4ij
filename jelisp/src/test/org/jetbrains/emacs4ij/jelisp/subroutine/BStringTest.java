...
public class BStringTest extends JelispTestCase {
  @Test
  ...
  public void testFormatNotEnoughArgs() {
    try {
      ...
      Assert.assertEquals("Not enough arguments for format string", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testFormatUnexpectedEndOfFormatString() {
    try {
      ...
      Assert.assertEquals("Format string ends in middle of format specifier", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testFormatInvalidFormatCharacter() {
    try {
      ...
      Assert.assertEquals("Invalid format operation %q", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testFormatH() {
    try {
      ...
      Assert.assertEquals("Invalid format operation %h", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testStringMatchOutOfRange() {
    try {
      ...
      Assert.assertEquals("'(args-out-of-range \"africa\" 10)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testSubstringOutOfRange1() {
    try {
      ...
      Assert.assertEquals("'(args-out-of-range \"hello\" -1 5)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testSubstringOutOfRange2() {
    try {
      ...
      Assert.assertEquals("'(args-out-of-range \"hello\" 1 7)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testSubstringOutOfRange3() {
    try {
      ...
      Assert.assertEquals("'(args-out-of-range \"hello\" 0 -1)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testSubstringOutOfRange4() {
    try {
      ...
      Assert.assertEquals("'(args-out-of-range \"hello\" 3 2)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testReadFromStringError() {
    try {
      ...
      Assert.assertEquals("'(args-out-of-range \"a\" 2 1)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testStringMatchBackReferenceInvalid() {
    try {
      ...
      Assert.assertEquals("'(invalid-regexp \"Invalid back reference\")", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }

...
public class CharTableTest extends JelispTestCase {
  @Test
  ...
  public void testMakeCharTableNegativeExtra() throws Exception {
    try {
      ...
      Assert.assertEquals("'(wrong-type-argument wholenump -1)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testMakeCharTableTooBigExtra() throws Exception {
    try {
      ...
      Assert.assertEquals("'(args-out-of-range 11 nil)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testGetExtraSlotLess() {
    try {
      ...
      Assert.assertEquals("'(args-out-of-range " + evaluateString("ct").toString() + " -1)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testGetExtraSlotMore() {
    try {
      ...
      Assert.assertEquals("'(args-out-of-range " + evaluateString("ct").toString() + " 10)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testSetParentWrong() {
    try {
      ...
      Assert.assertEquals("'(wrong-type-argument char-table-p 5)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testRangeWrong() {
    try {
      ...
      Assert.assertTrue(getCauseMsg(e).contains("Invalid RANGE argument to `char-table-range'"));
      return;
    }
    Assert.fail();
  }

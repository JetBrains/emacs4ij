...
public class CompletionTest extends JelispTestCase {
  @Test
  ...
  public void testTryCompletionNotLambda() {
    try {
      ...
      //from 'funcall
      Assert.assertEquals("'(invalid-function (anna \"*alla\"))", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testTryCompletionWithPredicateFail() {
    try {
      ...
      Assert.assertEquals("'(wrong-type-argument sequencep foobar2)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }

...
public class PredicateTest extends JelispTestCase {
  ...
  @Test
  public void zero() {
    Assert.assertEquals(LispSymbol.ourNil, evaluateString("(zerop ?q)"));
    Assert.assertEquals(LispSymbol.ourT, evaluateString("(zerop 0)"));
    Assert.assertEquals(LispSymbol.ourT, evaluateString("(zerop 0.0)"));
  }
}

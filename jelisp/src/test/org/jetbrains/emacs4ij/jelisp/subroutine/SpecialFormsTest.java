...
public class SpecialFormsTest extends JelispTestCase {
  @Test
  ...
  public void testCondWrongArg1() {
    try {
      ...
      Assert.assertEquals("'(wrong-type-argument listp 5)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testIfT () {
    try {
      ...
      Assert.assertEquals("'(wrong-number-of-arguments if 2)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  private static void conditionCaseErrorChecker (Object error, String expectedMessage) {
    ...
    if (error instanceof RuntimeException) {
      Assert.assertEquals(expectedMessage, JelispTestCase.getCauseMsg((Throwable) error));
      //return;
    }
  }
  ...
  public void testWrongChar() {
    try {
      ...
      Assert.assertEquals("'(invalid-read-syntax \"?\")", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testInteractiveListWrong() {
    try {
      ...
      Assert.assertEquals("'(wrong-type-argument listp 8)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }

...
public class SymbolTest extends JelispTestCase {
  @Test
  ...
  public void testSymbolFunctionVoidFunNonExistentSymbol() {
    try {
      ...
      Assert.assertEquals("'(void-function a)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testPropertyForUndefinedSymbol() {
    ...
    try {
      ...
      Assert.assertEquals("'(void-variable q)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testResetConst() {
    try {
      ...
      Assert.assertEquals("'(setting-constant t)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
  ...
  public void testInternConst() {
    try {
      ...
      Assert.assertEquals("'(setting-constant :q)", getCauseMsg(e));
      return;
    }
    Assert.fail();
  }
